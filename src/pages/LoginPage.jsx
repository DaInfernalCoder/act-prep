...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-80 text-center">
        <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center mx-auto mb-6">
          <span className="text-white font-black text-base">A</span>
        </div>
        <h1 className="text-xl font-bold text-gray-900 mb-1">ACT Prep</h1>
        <p className="text-sm text-gray-400 mb-8">Sign in to track your progress</p>
        <button
          onClick={signIn}
